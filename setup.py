"""
Setup Module to setup Python Handlers for the jupyterlab-extension extension.
"""
import os
...
data_files_spec = [
    ...
    ("etc/jupyter/jupyter_notebook_config.d",
     "jupyter-config", "jupyterlab_extension.json"),
]
...
setup_args = dict(
    name=name,
    version=version,
    url="https://github.com/platiagro/jupyterlab-extension",
    author="Fabio Beranizo Fontes Lopes",
    description="A JupyterLab extension that integrates with PlatIAgro",
    long_description= long_description,
    long_description_content_type="text/markdown",
    cmdclass= cmdclass,
    packages=setuptools.find_packages(),
    install_requires=[
        "jupyterlab @ git+https://github.com/platiagro/jupyterlab.git@v0.2.0-jupyterlab-v3.0.16#egg=jupyterlab",
        "requests~=2.0",
    ],
    zip_safe=False,
